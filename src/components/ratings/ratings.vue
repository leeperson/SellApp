<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect @selects="selectTypes" @toggles="toggleContents" :ratings="ratings" :only-content="onlyContent" :select-type="selectType" :desc="desc"></ratingselect>
